...
import com.synclab.internship.keytest.client.ServiceBClient;
...
public class ServiceCaller {
    ...
    public ServiceCaller(KeyPairBean keyPairBean, ServiceAcClient serviceAc, ServiceBClient serviceB)
    ...
    public Message postMessage(String from, String to, PublicKey toKey, String text)
        ...
        try {
            HttpResponse<Message> response = serviceB.postMessage(message);
            if (response.getStatus().equals(HttpStatus.OK)) {
